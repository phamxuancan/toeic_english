    ...
    {!! Form::open(array('url' => '', 'class'=>'form-horizontal', 'method' => 'POST', 'role' => 'form', 'id'=>'form_edit', 'enctype'=>'multipart/form-data')) !!}
        <div class="row form-group ">
            <div class="col-lg-12 col-md-12">
                <?php echo Form::label('type', 'Loại câu hỏi: ', array('class' => 'control-label col-lg-3 '))?>
                <div class="col-lg-9">
            ...
            <div class="form-group">
                <div class="col-lg-12 col-md-12">
                    <?php echo Form::label('audio', 'Audio*:' ,array('class'=>'col-lg-3'))?>
                    <div class="col-lg-9">
        ...
        @if($question->type == 'text')
            <div class="form-group">
                <div class="col-lg-12 col-md-12">
                    <?php echo Form::label('Question', 'Question :' ,array('class'=>'col-lg-3'))?>
                    <div class="col-lg-9">
        ...
        @endif
             <div class="form-group">
                    <div class="col-lg-12 col-md-12">
                        <?php echo Form::label('a', 'Trả lời A:' ,array('class'=>'col-lg-3'))?>
                        <div class="col-lg-9">
              ...
              <div class="form-group">
                    <div class="col-lg-12 col-md-12">
                        <?php echo Form::label('b', 'Trả lời B:' ,array('class'=>'col-lg-3'))?>
                        <div class="col-lg-9">
             ...
             <div class="form-group">
                    <div class="col-lg-12 col-md-12">
                        <?php echo Form::label('c', 'Trả lời C:' ,array('class'=>'col-lg-3'))?>
                        <div class="col-lg-9">
             ...
             <div class="form-group">
                    <div class="col-lg-12 col-md-12">
                        <?php echo Form::label('d', 'Trả lời D:' ,array('class'=>'col-lg-3'))?>
                        <div class="col-lg-9">
              ...
              <div class="form-group">
                    <div class="col-lg-12 col-md-12">
                        <?php echo Form::label('answer_correct', 'Đáp án đúng:' ,array('class'=>'col-lg-3'))?>
                        <div class="col-lg-9">

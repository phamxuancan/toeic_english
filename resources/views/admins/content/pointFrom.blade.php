                    ...
                    <li style="width: 165px;text-align: center;">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle" onclick="User.managerUser();"><b class="fa fa-user"></b> Quản lý người dùng</a>
                          <ul class="dropdown-menu">
                            <li><a style="width: 165px;" href="#" data-toggle="modal" data-target="#createUserAdmin"><b class="fa fa-plus"></b>Thêm người dùng</a></li>
                        </ul>
                    </li>
                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                    <form class="form-inline">
                        <div class="form-group">
                            <label class="control-label" for="fromPoint">Điểm từ:</label>
                            <input type="text" class="form-control" id="fromPoint" >
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="top_point"> Tới:</label>
                            <input type="text" class="form-control" id="toPoint">
                        </div>
                            <button type="button" onclick="User.pointFrom(this);" data-loading-text="Searching..." class="btn btn-primary">Search</button>
                    </form>
                </div>
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="admin_point">
